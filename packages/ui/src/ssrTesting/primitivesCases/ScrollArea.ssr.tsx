import { ScrollArea, ScrollBar } from "@/primitives/ScrollArea/ScrollArea";
...
const scrollAreaSSR: SSRComponent<React.ComponentProps<typeof ScrollArea>> = {
